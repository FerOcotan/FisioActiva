<div x-data="{ 
...
}" x-init="$watch('open', value => localStorage.setItem('sidebarOpen', JSON.stringify(value)))" x-cloak
    ...
    <div :class="open ? 'w-60' : 'w-20'"
      ...
      <!-- Área de Usuario con icono y nombre centrados -->
<div class="flex flex-col items-center justify-center py-2">
    <div class="relative group">
        <!-- Ícono de usuario - Cambia tamaño según estado del sidebar -->
        <svg xmlns="http://www.w3.org/2000/svg"
            class="text-gray-400 border-2 border-gra-100 rounded-full p-1 transition-all duration-300 bg-white"
        ...
        <a href="{{ route('profile.edit') }}"
            ...
            :class="open ? 'p-1' : 'p-0.5'" :title="open ? 'Editar perfil' : ''">
            <svg xmlns="http://www.w3.org/2000/svg" class="transition-all duration-300"
                :class="open ? 'h-4 w-4' : 'h-3 w-3'" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <span x-show="open" x-transition:enter="transition ease-out duration-300"
        ...
        <nav class="mt-6">
            <ul class="space-y-2 px-2">
                ...
                <x-sidebar-item route="dashboardpaciente.index" label="Inicio"
                    icon='<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>' />
                <x-sidebar-item route="dashboardpaciente.create" label="Q&A"
                ...
                <x-sidebar-item route="economico.index" label="Finanzas"
